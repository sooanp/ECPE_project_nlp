...
if __name__ == "__main__":
    ...
    conv_train_data , label_train_data = extractor.conv_pair_for_bert("./data/ecf/train_dev_with_cause.json")
    conv_test_data, label_test_data = extractor.conv_pair_for_bert("./data/ecf/test_with_cause.json")
    print("Loading data complete!")

    # Set this to True to extract features first
    ...
    # Set this to True if you want to save feature file
    set_save = False
